...
# /////we use these parameters in the cmap function
...
# ////to split the all elements of cmap using split function and split by comma
split_elements=cmap.split(' , ')
# print(split_elements)
save_image_list=[]
# split_elements=[]
# /////to itrate all the elements of cmap in picture we use for loop
