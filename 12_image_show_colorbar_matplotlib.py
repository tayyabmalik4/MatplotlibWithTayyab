...
# //////if we want to read the image data than we use image using matplotlib in python

import matplotlib.pyplot as plt
import matplotlib.image as mpimg

# /////we use imread function to showing the image
img=mpimg.imread('11.2_Figure_2.png')
img1=mpimg.imread('11.1_Figure_1.png')
# print(img)

# ///checking type of the image
# print(type(img))

# /////chacking the how many rows and columns or attributes
# print(img.shape)

# /////checking the dimentional
# print(img.ndim)

# ////if we want to maximize or minnize the figure size thanwe use figure function in matplotlib
# plt.figure(figsize=(13,13))

# ////if we want don't show the axis than we use axis('off)
# plt.axis('off')
...
# ////if we use cmap properly than we must use the 2d array instance of 3d arrray
# arr2d=img[1:,:,1]
# arr2d=img1[:,:,2]
# /////to showing the image use imshow function
# plt.imshow(img,cmap='spring')
# plt.imshow(arr2d,cmap='hot')
# /////if we want to show the side color bar than we use colorbar function and 
# ////this detect automatic colors which is exists in the figure
# plt.colorbar()
...
# ****************this is the uploading pic through path and showing and also making pangas
plt.figure(figsize=(13,13))
